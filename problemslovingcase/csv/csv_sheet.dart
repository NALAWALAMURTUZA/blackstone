...
class CsvSheet {
  ...
  CsvSheet(String contents,
      {bool headerRow: false, String fieldSep: ',', String lineSep: '\n'}) {
    _fakeColumn = new CsvColumn(this);
  ...
  getValue(column, row) => _contents[row][column];
